...
export class WaveMaterial extends gfx.Material3
{
    ...
    constructor()
    {
        ...
        this.kAmbientUniform = WaveMaterial.shader.getUniform(this.gl, 'kAmbient');
        this.kDiffuseUniform = WaveMaterial.shader.getUniform(this.gl, 'kDiffuse');
        this.kSpecularUniform = WaveMaterial.shader.getUniform(this.gl, 'kSpecular');
        this.shininessUniform = WaveMaterial.shader.getUniform(this.gl, 'shininess');

        this.textureUniform = WaveMaterial.shader.getUniform(this.gl, 'textureImage');
        this.useTextureUniform = WaveMaterial.shader.getUniform(this.gl, 'useTexture');

        this.modelUniform = WaveMaterial.shader.getUniform(this.gl, 'modelMatrix');
        this.normalUniform = WaveMaterial.shader.getUniform(this.gl, 'normalMatrix');
        this.viewUniform = WaveMaterial.shader.getUniform(this.gl, 'viewMatrix');
        this.projectionUniform = WaveMaterial.shader.getUniform(this.gl, 'projectionMatrix');

        this.eyePositionWorldUniform = WaveMaterial.shader.getUniform(this.gl, 'eyePositionWorld');
        this.numLightsUniform = WaveMaterial.shader.getUniform(this.gl, 'numLights');
        this.lightTypesUniform = WaveMaterial.shader.getUniform(this.gl, 'lightTypes');
        this.lightPositionsWorldUniform = WaveMaterial.shader.getUniform(this.gl, 'lightPositionsWorld');
        this.ambientIntensitiesUniform = WaveMaterial.shader.getUniform(this.gl, 'ambientIntensities');
        this.diffuseIntensitiesUniform = WaveMaterial.shader.getUniform(this.gl, 'diffuseIntensities');
        this.specularIntensitiesUniform = WaveMaterial.shader.getUniform(this.gl, 'specularIntensities');

        this.positionAttribute = WaveMaterial.shader.getAttribute(this.gl, 'position');
    ...
    draw(mesh: gfx.Mesh3, camera: gfx.Camera, lightManager: gfx.LightManager): void
    {
        ...
        this.gl.useProgram(WaveMaterial.shader.getProgram());
